from WindowPuzzleBoardSize import *
from SyntheticPlayer import *
from HandlingFileIO import *
from WindowError import *
from WindowNoSolution import *
from AlgorithmsBruteForce import *
from ElectionDisabledCells import *
